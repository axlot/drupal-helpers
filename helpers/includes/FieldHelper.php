...
class FieldHelper {
  ...
  public static function getTextValue($entity_type, $entity, $field_name, $safe = true)
      {
      $field_value = FieldHelper::getValue($entity_type, $entity, $field_name);
  ...
  public static function getFieldEntity($entity_type, $entity, $field_name, $column = NULL) {
    $entities = static::getFieldEntities($entity_type, $entity, $field_name, $column);
